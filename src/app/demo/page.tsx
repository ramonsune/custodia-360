        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-bold text-gray-900 text-center mb-3">Delegados</h3>
              <ul className="text-sm text-gray-600 space-y-2">
                <li>• <strong>Principal:</strong> Recibe comunicaciones y actúa</li>
                <li>• <strong>Suplente:</strong> Sustituye cuando es necesario</li>
                <li>• Ambos formados y certificados</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4 mx-auto">
                <span className="text-green-600 text-xl font-bold">P</span>
              </div>
              <h3 className="text-lg font-bold text-gray-900 text-center mb-3">Personal</h3>
              <ul className="text-sm text-gray-600 space-y-2">
                <li>• <strong>Entrenadores/Monitores:</strong> Contacto directo</li>
                <li>• <strong>Administrativos:</strong> Apoyo y gestión</li>
                <li>• Formación obligatoria para todos</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                <li>• Conocen el plan de protección</li>
                <li>• Contacto directo con delegados</li>
                <li>• Colaboran en la protección</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center mb-4 mx-auto">
                <span className="text-orange-600 text-xl font-bold">R</span>
              </div>
              <h3 className="text-lg font-bold text-gray-900 text-center mb-3">Dirección</h3>
              <ul className="text-sm text-gray-600 space-y-2">
                <li>• Implementa el plan</li>
                <li>• Designa delegados</li>
                <li>• Garantiza recursos necesarios</li>
              </ul>
            </div>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 border border-gray-200 rounded">
                      <div className="text-sm font-medium text-gray-900 mb-2">Delegado Principal</div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="text-gray-900">Designa delegado</strong>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">Dashboard Delegado</div>
            ...
            <div className="order-2 lg:order-1">
              <div className="bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="bg-orange-600 text-white p-4">
                  ...
                  <p className="text-orange-100 text-sm">María García - Delegado Principal</p>
                </div>
