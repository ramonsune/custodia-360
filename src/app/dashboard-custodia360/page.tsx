...
export default function DashboardCustodia360() {
  ...
  useEffect(() => {
    const checkAuth = () => {
      ...
      if (!session.token) {
        console.warn('⚠️ Dashboard Custodia360: Sin sesión')
        router.push('/login')
        return false
      }
      ...
      if (isExpired()) {
        console.warn('⚠️ Dashboard Custodia360: Sesión expirada')
        router.push('/login')
        return false
      }
      ...
      if (session.role !== 'ADMIN') {
        console.warn('⚠️ Dashboard Custodia360: Rol no autorizado:', session.role)
        router.push('/login')
        return false
      }

      console.log('✅ Dashboard Custodia360: Acceso autorizado')
      return true
    }
  ...
  const verificarServicios = async () => {
    ...
    try {
      // 1. VERIFICAR WEB (siempre operativo si estamos aquí)
      serviciosHealth.push({
        ...
        mensaje: 'Aplicación web funcionando correctamente'
      })
      ...
      try {
        if (supabase) {
          ...
          serviciosHealth.push({
            ...
            ultimaVerificacion: new Date().toISOString(),
            mensaje: latenciaSupabase > 1000 ? 'Base de datos con latencia elevada' : 'Conexión a base de datos correcta'
          })
        } else {
          serviciosHealth.push({
            servicio: 'SUPABASE',
        ...
        serviciosHealth.push({
          ...
          latencia: 0,
          ultimaVerificacion: new Date().toISOString(),
          mensaje: 'Error de conexión a Supabase'
        })
      }
      ...
      try {
        ...
        serviciosHealth.push({
          ...
          latencia: 0,
          ultimaVerificacion: new Date().toISOString(),
          mensaje: 'No se pudo verificar servicio de facturación'
        })
      }
  ...
  // Verificar servicios automáticamente al cargar y cada 2 minutos
  useEffect(() => {
    verificarServicios()
          ...
          <div className="p-6">
              ...
              <div className="border-2 border-blue-200 rounded-lg p-6 bg-blue-50">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-white p-5 rounded-lg shadow">
                    <h4 className="font-bold text-gray-900 mb-4 text-lg">Información General</h4>
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="font-medium text-gray-700">Fecha contratación:</span>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow">
                    <h4 className="font-bold text-gray-900 mb-4 text-lg">Métricas de Cumplimiento</h4>
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between">
                ...
                <div className="bg-white p-5 rounded-lg shadow mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-3 text-sm">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">Delegado de Protección asignado</span>
                    </div>
                    <div className="flex items-center">
                      <span className="text-green-600 mr-2 text-xl">✓</span>
                      <span className="text-gray-700">Plan de Protección implementado</span>
                    </div>
                    <div className="flex items-center">
                      <span className="text-green-600 mr-2 text-xl">✓</span>
                      <span className="text-gray-700">Personal formado según normativa</span>
                    </div>
                    <div className="flex items-center">
                      <span className="text-green-600 mr-2 text-xl">✓</span>
                      <span className="text-gray-700">Protocolos de actuación establecidos</span>
                    </div>
                  </div>
                </div>
            ...
            {!entidadSeleccionadaInforme && (
              <div className="text-center py-12 text-gray-500 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                ...
                <p className="text-lg font-medium">Selecciona una entidad del menú desplegable para ver su informe</p>
              </div>
            )}
          </div>
        </div>
