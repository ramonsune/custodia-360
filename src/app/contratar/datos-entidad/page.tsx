                  ...
                  {planPreseleccionado ? (
                    <div className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50">
                      <span className="text-gray-700">
                        {planPreseleccionado === '1-100' && '1-100 menores (Plan 100 - 38€)'}
                        {planPreseleccionado === '101-250' && '101-250 menores (Plan 200 - 78€)'}
                        {planPreseleccionado === '251-500' && '251-500 menores (Plan 500 - 210€)'}
                        {planPreseleccionado === '501+' && '+501 menores (Plan 500+ - 500€)'}
                        {planPreseleccionado === 'temporal' && 'Evento temporal (Custodia Temporal - 100€)'}
                        {planPreseleccionado === 'kit' && 'Solo material (Kit Comunicación - 30€)'}
                      </span>
                      <p className="text-sm text-blue-600 mt-1">Plan seleccionado desde la página anterior</p>
                    ...
                    >
                      ...
                      <option value="1-100">1-100 menores (Plan 100 - 38€)</option>
                      <option value="101-250">101-250 menores (Plan 200 - 78€)</option>
                      <option value="251-500">251-500 menores (Plan 500 - 210€)</option>
                      <option value="501+">+501 menores (Plan 500+ - 500€)</option>
