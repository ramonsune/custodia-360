  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (resultEmails.success) {
        // Guardar entityId si fue creado
        if (resultEmails.entityId) {
          console.log('✅ Entity ID guardado:', resultEmails.entityId)
          localStorage.setItem('lastEntityId', resultEmails.entityId)
        }
