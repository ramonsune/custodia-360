      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/login"
              className="text-blue-600 px-6 py-2 rounded-lg font-bold hover:text-blue-700 transition-colors"
            >
              Acceso
            </Link>
          </div>
          ...
          <div className="md:hidden flex items-center space-x-2">
            <Link
              href="/login"
              className="text-blue-600 px-3 py-2 rounded-lg text-sm font-bold hover:text-blue-700 transition-colors"
            >
              Acceso
            </Link>
            <button
