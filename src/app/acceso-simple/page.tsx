  ...
  return (
    <div style={{ padding: '40px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <a href="/dashboard-delegado" style={{ textDecoration: 'none' }}>
          <div style={{ backgroundColor: '#10b981', color: 'white', padding: '30px', borderRadius: '10px', textAlign: 'center', cursor: 'pointer' }}>
            <h2 style={{ margin: '0 0 10px 0' }}>DELEGADO</h2>
            <p style={{ margin: '0' }}>Dashboard Delegado</p>
          </div>
        </a>

        <a href="/dashboard-suplente" style={{ textDecoration: 'none' }}>
          <div style={{ backgroundColor: '#f59e0b', color: 'white', padding: '30px', borderRadius: '10px', textAlign: 'center', cursor: 'pointer' }}>
            <h2 style={{ margin: '0 0 10px 0' }}>SUPLENTE</h2>
            <p style={{ margin: '0' }}>Dashboard Suplente</p>
          </div>
        </a>

        <a href="/formacion-delegado" style={{ textDecoration: 'none' }}>
        ...
        <a href="/formacion-suplente" style={{ textDecoration: 'none' }}>
