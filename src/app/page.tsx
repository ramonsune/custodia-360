      ...
      <div className="bg-white pt-16 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            {/* Tagline azul */}
            <div className="mb-8">
              <span className="inline-block bg-blue-50 text-blue-700 px-6 py-3 rounded-full text-sm font-medium border border-blue-200">
                <span className="text-blue-600 font-bold">Custodia360</span> <span className="text-gray-900">primera empresa automatizada especializada en cumplimiento normativo LOPIVI</span>
              </span>
            </div>
            ...
            <div className="mb-8">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight">
                <span className="block"><span className="text-orange-500">Tu entidad</span></span>
                <span className="block mt-2">¿Cumple la <span className="text-blue-600">LOPIVI<span className="text-blue-600">?</span></span></span>
                <span className="block mt-2">¿Tiene un <span className="text-blue-600">Plan de Protección<br />Infantil<span className="text-blue-600">?</span></span></span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                <span className="text-blue-600 font-semibold">Custodia360</span> primera herramienta especializada en cumplimiento normativo LOPIVI completamente automatizada que le permite implementar la LOPIVI y un Plan de Protección Infantil automatizado, en 72 horas.
              </p>
            </div>
            ...
            <div className="mb-16">
              <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                  <div className="text-5xl md:text-6xl font-bold text-gray-900 mb-2">72h</div>
                  <div className="text-gray-600 font-medium text-lg">Implementación completa</div>
                </div>
                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                  <div className="text-5xl md:text-6xl font-bold text-gray-900 mb-2">97%</div>
                  <div className="text-gray-600 font-medium text-lg">Reducción de costes respecto a lo habitual</div>
                </div>
                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                  <div className="text-5xl md:text-6xl font-bold text-gray-900 mb-2">100%</div>
                  <div className="text-gray-600 font-medium text-lg">Sistema automatizado</div>
                </div>
              </div>
            </div>
      ...
      <div className="bg-gray-50 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-12 text-center text-white">
            <h3 className="text-3xl font-bold mb-4">Resultado: Conforme con la LOPIVI</h3>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center">
              ...
              <div className="text-blue-600 font-semibold">10 minutos</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-green-600 font-semibold">24 horas</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-purple-600 font-semibold">48 horas</div>
            </div>
          </div>
