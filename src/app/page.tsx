...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Animación del teléfono después de 3 segundos
    const timer4 = setTimeout(() => {
      setShowPhoneAnimation(true)
    }, 3000)

    // Animaciones secuenciales de secciones
    const sectionTimers = [
      setTimeout(() => setSectionsVisible(prev => ({ ...prev, lopivi: true })), 1500),
      setTimeout(() => setSectionsVisible(prev => ({ ...prev, plan: true })), 2000),
      setTimeout(() => setSectionsVisible(prev => ({ ...prev, custodia: true })), 2500),
      setTimeout(() => setSectionsVisible(prev => ({ ...prev, proceso: true })), 3000),
      setTimeout(() => setSectionsVisible(prev => ({ ...prev, estadisticas: true })), 3500),
      setTimeout(() => setSectionsVisible(prev => ({ ...prev, sanciones: true })), 4000),
      setTimeout(() => setSectionsVisible(prev => ({ ...prev, control: true })), 4500),
    ]
    ...
    <>
      ...
      <section className="bg-white py-12 sm:py-16 lg:py-20 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto px-4 sm:px-0">
            <div className={`bg-white rounded-xl shadow-lg p-4 sm:p-6 text-center border border-gray-200 hero-card card-hover-effect ${heroVisible ? 'visible' : ''}`}
            ...
            <div className={`bg-white rounded-xl shadow-lg p-4 sm:p-6 text-center border border-gray-200 hero-card card-hover-effect ${heroVisible ? 'visible' : ''}`}
              ...
              <div className="text-3xl sm:text-4xl font-bold text-black mb-2 pulse-animation">97%</div>
            ...
            <div className={`bg-white rounded-xl shadow-lg p-4 sm:p-6 text-center border border-gray-200 sm:col-span-2 lg:col-span-1 hero-card card-hover-effect ${heroVisible ? 'visible' : ''}`}
                 style={{ animationDelay: '0.6s' }}>
              <div className="text-3xl sm:text-4xl font-bold text-black mb-2 bounce-animation">100%</div>
      ...
      <section className="py-20 bg-white animate-on-scroll">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white border border-gray-300 rounded-xl p-8 card-hover-effect animate-on-scroll">
      ...
      <section className="py-20 bg-gray-50 animate-on-scroll">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white rounded-xl p-8 shadow-lg card-hover-effect animate-on-scroll">
      ...
      <section className="py-20 bg-white animate-on-scroll">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center animate-on-scroll hover:transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <div className="text-center animate-on-scroll hover:transform hover:-translate-y-2 transition-transform duration-300" style={{animationDelay: '0.2s'}}>
            ...
            <div className="text-center animate-on-scroll hover:transform hover:-translate-y-2 transition-transform duration-300" style={{animationDelay: '0.4s'}}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <span className="text-blue-600 text-6xl font-bold step-number">1</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <span className="text-green-600 text-6xl font-bold step-number">2</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <span className="text-purple-600 text-6xl font-bold step-number">3</span>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center">
              <div className="relative inline-block">
                ...
                <div className={`w-72 h-[540px] bg-black rounded-[3rem] p-2 shadow-2xl relative phone-mockup mockup-glow ${showPhoneAnimation ? 'phone-float phone-entrance' : ''}`}
                  ...
                  <div className="w-full h-full bg-white rounded-[2.7rem] overflow-hidden relative">
                    ...
                    {/* Status bar */}
                    <div className="flex justify-between items-center pt-12 px-6 pb-2 phone-screen-content">
                    ...
                    {/* Screen content */}
                    <div className="px-4 h-full phone-screen-content">
                      {/* Header */}
                      ...
                      <div className="space-y-4 mb-6">
                        <div className="border border-green-200 rounded-lg p-3 bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
                          <div className="text-sm font-medium text-green-800">Estado LOPIVI</div>
                          <div className="text-2xl font-bold text-green-600">97%</div>
                        </div>

                        <div className="border border-blue-200 rounded-lg p-3 bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
                          <div className="text-sm font-medium text-blue-800">Casos Activos</div>
                          <div className="text-xl font-bold text-blue-600">3</div>
                        </div>

                        <div className="border border-orange-200 rounded-lg p-3 bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
                      ...
                      {/* Action buttons */}
                      <div className="space-y-3">
                        <button className="w-full bg-blue-600 text-white py-3 rounded-lg text-sm font-medium shadow-sm hover:bg-blue-700 transition-colors duration-300">
                          Nuevo Caso
                        </button>
                        <button className="w-full bg-purple-600 text-white py-3 rounded-lg text-sm font-medium shadow-sm hover:bg-purple-700 transition-colors duration-300">
                          Ver Alertas
                        </button>
                      </div>
                    </div>
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-700 mb-6 control-text">
                Controla todo desde <span className="text-blue-600">cualquier lugar</span>
              </h2>

              <div className="space-y-6 mb-8 control-text">
                <div className="hover:transform hover:translateX-2 transition-transform duration-300">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 text-white control-text hover:shadow-xl transition-shadow duration-300">
                ...
                <Link
                  ...
                  className="bg-white text-blue-600 px-6 py-2 rounded-lg font-bold hover:bg-gray-100 transition-all duration-300 inline-block hover:transform hover:scale-105"
                >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <span className="text-gray-400">Guía de Implementación</span>
                </li>
              </ul>
            </div>
