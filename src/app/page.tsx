      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="relative flex justify-center items-center min-h-[600px]">
            ...
            {/* Dashboard flotantes alrededor del iPhone */}

            {/* Dashboard 1 - Superior izquierda */}
            <div className="absolute top-4 left-4 w-48 h-32 bg-white border border-gray-300 rounded-lg shadow-xl transform -rotate-12 hover:rotate-0 transition-transform duration-300">
              <div className="p-3">
                ...
                <div className="grid grid-cols-3 gap-1">
                  <div className="bg-blue-50 p-1 rounded text-center">
                    <div className="text-xs font-bold text-blue-600">156</div>
                  </div>
            ...
            {/* Dashboard 2 - Superior derecha */}
            <div className="absolute top-4 right-4 w-48 h-32 bg-white border border-gray-300 rounded-lg shadow-xl transform rotate-12 hover:rotate-0 transition-transform duration-300">
              <div className="p-3">
                <div className="flex items-center justify-between mb-2">
                ...
                <div className="space-y-1">
                  <div className="bg-green-100 h-2 rounded w-full"></div>
            ...
            {/* Dashboard 3 - Izquierda centro */}
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-40 h-28 bg-white border border-gray-300 rounded-lg shadow-xl transform -rotate-6 hover:rotate-0 transition-transform duration-300">
              <div className="p-2">
                <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-xs text-gray-600">
                  <p>María López</p>
                  <p className="text-green-600">Certificada</p>
                </div>
            ...
            {/* Dashboard 4 - Derecha centro */}
            <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-40 h-28 bg-white border border-gray-300 rounded-lg shadow-xl transform rotate-6 hover:rotate-0 transition-transform duration-300">
              <div className="p-2">
                <div className="flex items-center justify-between mb-2">
            ...
            {/* Dashboard 5 - Inferior izquierda */}
            <div className="absolute bottom-4 left-4 w-44 h-30 bg-white border border-gray-300 rounded-lg shadow-xl transform rotate-8 hover:rotate-0 transition-transform duration-300">
              <div className="p-3">
                <div className="flex items-center justify-between mb-2">
                ...
                <div className="grid grid-cols-2 gap-1 text-xs">
                  <div className="bg-green-50 p-1 rounded">
                    <div className="text-green-600">Plan ✓</div>
                  </div>
                  <div className="bg-blue-50 p-1 rounded">
                    <div className="text-blue-600">Código ✓</div>
                  </div>
                </div>
              </div>
            </div>

            {/* Dashboard 6 - Inferior derecha */}
            <div className="absolute bottom-4 right-4 w-44 h-30 bg-white border border-gray-300 rounded-lg shadow-xl transform -rotate-8 hover:rotate-0 transition-transform duration-300">
              <div className="p-3">
                <div className="flex items-center justify-between mb-2">
