...
export default function CertificadoDelegadoPage() {
  ...
  const descargarCertificado = async () => {
    ...
    try {
      ...
      // Sello "CUSTODIA360 LOPIVI FORMADO" en la parte superior derecha
      doc.setDrawColor(37, 99, 235);
      doc.setLineWidth(2);
      doc.roundedRect(pageWidth - 85, 12, 70, 32, 3, 3);

      doc.setFontSize(10);
      doc.setFont('helvetica', 'bold');
      doc.setTextColor(37, 99, 235);
      doc.text('CUSTODIA360', pageWidth - 50, 22, { align: 'center' });
      doc.text('LOPIVI', pageWidth - 50, 28, { align: 'center' });
      doc.text('FORMADO', pageWidth - 50, 34, { align: 'center' });
      ...
      // Nombre del usuario - Fernando Del Olmo
      doc.setFontSize(20);
      doc.setTextColor(37, 99, 235);
      doc.text('FERNANDO DEL OLMO', pageWidth / 2, 85, { align: 'center' });
          ...
          <div className="flex justify-between items-center py-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Certificado Oficial <span className="text-blue-600">Custodia360</span>
              </h1>
