...
export default function TestUnicoPage() {
  ...
  // Redirección automática al certificado si el test está aprobado
  useEffect(() => {
    if (mostrarResultado && progresoTest?.aprobado) {
  ...
  }, [mostrarResultado, progresoTest?.aprobado, router])
                ...
                <>
                  <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
                    <p className="text-green-700 mb-4 text-lg">
                      ...
                      Has completado exitosamente el Test de Certificación LOPIVI especializado para clubes deportivos.
                    </p>
                    <p className="text-green-600 mb-4">
                      <strong>¡Ya eres oficialmente un/a Delegado/a de Protección certificado/a!</strong><br/>
                      A continuación verás tu certificado oficial para que puedas descargarlo y guardarlo.
                    </p>
                  </div>
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <p className="text-blue-700 text-sm text-center">
                      Redirigiendo automáticamente a su certificado en <span id="countdown" className="font-bold">5</span> segundos...
                    </p>
                  </div>
                </>
              )}
