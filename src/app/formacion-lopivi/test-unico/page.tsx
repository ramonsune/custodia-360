      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-4xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h1 className="text-xl font-bold text-gray-900">Resultado del Test LOPIVI</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white rounded-xl shadow-sm p-8 text-center">
            <div className={`text-6xl mb-4 ${progresoTest.aprobado ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                {progresoTest.aprobado
                  ? `¡Excelente! Ha superado el mínimo requerido del 80%`
                  : `Necesita al menos 80% para aprobar. Puede intentarlo nuevamente.`
                }
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Test de Certificación LOPIVI</h1>
          ...
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Necesita responder correctamente al menos 24 de las 30 preguntas (80%) para aprobar.
