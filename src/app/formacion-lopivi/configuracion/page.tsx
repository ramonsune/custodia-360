...
export default function ConfiguracionFormacionPage() {
  ...
  const calcularDiasRestantes = (fechaInicio: Date) => {
    ...
    const diferencia = 30 - Math.floor((ahora.getTime() - fechaInicio.getTime()) / (1000 * 60 * 60 * 24))
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full h-[90vh] flex flex-col">
            <div className="flex items-center justify-between p-6 border-b">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {scrollProgress >= 90 ? 'Descargar' : `Leer ${Math.round(scrollProgress)}%`}
                </button>
                <button
            ...
            <div className="p-6 border-t bg-gray-50">
              <div className="flex justify-between items-center">
                ...
                >
                  {scrollProgress >= 90 ? 'MARCAR COMO LEÍDO' : `LEER HASTA EL FINAL (${Math.round(scrollProgress)}%)`}
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="text-center pt-4">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Al continuar, se iniciará el periodo de 30 días para entregar los certificados
                </p>
              </div>
            </div>
          </div>
