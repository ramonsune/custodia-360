...
export default function DelegadoSetupPage() {
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Ya eres {sessionData?.tipo === 'principal' ? 'Delegado Principal' : 'Delegado Suplente'} certificado
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              Configuración inicial de su entidad
            </h2>

            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
              <h3 className="font-semibold text-blue-900 mb-2">
                Siguiente paso: Registro de miembros
              </h3>
              <p className="text-blue-800 text-sm leading-relaxed">
                Para completar el cumplimiento LOPIVI, todos los miembros de su entidad deben
                registrarse y completar la formación correspondiente según su rol. El sistema
                generará un enlace personalizado que deberá enviar a todos los miembros.
              </p>
            </div>
            ...
            <button
              ...
              disabled={configurando || !entidadConfig.nombreCompleto || !entidadConfig.tipoEntidad}
              className={`w-full py-3 px-6 rounded-lg font-semibold text-white transition-colors ${
                configurando || !entidadConfig.nombreCompleto || !entidadConfig.tipoEntidad
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Comunicar a todos los miembros de la entidad
          </h2>
            ...
            <div className="bg-white border rounded-lg p-4 text-sm text-gray-800 leading-relaxed">
              ...
              <div className="border-t pt-3">
                ...
                <ul className="list-disc ml-6 mb-3 space-y-1">
                  <li>Obligatorio por ley para nuestra entidad</li>
                  <li>Completamente confidencial y seguro</li>
                  <li>Necesario para mantener nuestra actividad con menores</li>
                  <li>Estimado en 5 minutos de duración</li>
                </ul>
                ...
                <p>Teléfono: {entidadConfig.telefono}</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={() => {
                const mensaje = `Estimado miembro de ${entidadConfig.nombreCompleto},
...
Custodia360 - Sistema de Gestión LOPIVI`
            ...
            >
              Copiar mensaje completo para enviar
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="space-y-3 text-gray-700">
            <p>
              <strong>1.</strong> Copie el mensaje completo usando el botón superior
            </p>
            <p>
              <strong>2.</strong> Envíelo por email a todos los miembros de su entidad
            </p>
            <p>
              <strong>3.</strong> También puede enviarlo por WhatsApp o SMS si lo prefiere
            </p>
            <p>
              <strong>4.</strong> Los miembros recibirán formación automática tras registrarse
            </p>
            <p>
              <strong>5.</strong> Podrá seguir el progreso desde su dashboard
            </p>
          </div>
        </div>
