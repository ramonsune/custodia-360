                ...
                <div key={caso.id} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-semibold text-gray-800">Acciones como Delegado Suplente:</h4>
                      <button
                        onClick={() => {
            ...
            <div className="p-6">
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-4">
                  ...
                  <div className="bg-white p-3 rounded border border-orange-200">
                    <h4 className="font-semibold text-orange-800 mb-2">SERVICIOS SOCIALES Y PROTECCIÓN</h4>
                    <div className="space-y-1 text-sm">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div
                  className="border-2 border-gray-200 rounded-lg p-4 hover:border-orange-300 hover:bg-orange-50 cursor-pointer transition-all"
                  onClick={() => {
                    setTipoProtocolo('coordinacion-delegado-principal')
                ...
                <div
                  className="border-2 border-gray-200 rounded-lg p-4 hover:border-orange-300 hover:bg-orange-50 cursor-pointer transition-all"
                  onClick={() => {
                    setTipoProtocolo('incidente-suplente')
                    setShowProtocoloCaso(true)
                  }}
                >
                  <div className="flex items-start gap-3">
                ...
                <div
                  className="border-2 border-gray-200 rounded-lg p-4 hover:border-orange-300 hover:bg-orange-50 cursor-pointer transition-all"
                  onClick={() => {
                    setTipoProtocolo('apoyo-caso-complejo')
                    setShowProtocoloCaso(true)
                  }}
                >
                  <div className="flex items-start gap-3">
                ...
                <div
                  className="border-2 border-gray-200 rounded-lg p-4 hover:border-orange-300 hover:bg-orange-50 cursor-pointer transition-all"
                  onClick={() => {
                    setTipoProtocolo('comunicacion-familias')
                    setShowProtocoloCaso(true)
                  }}
                >
                  <div className="flex items-start gap-3">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Gestionar Caso: {casoSeleccionado.titulo}</h2>
                  <p className="text-sm text-gray-600">ID: {casoSeleccionado.id} - Vista Suplente</p>
                </div>
                <button
            ...
            <div className="p-6">
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
                <h3 className="font-bold text-purple-900 mb-2">Rol de Delegado/a Suplente</h3>
                <p className="text-purple-800 text-sm">
                  Como suplente, tu función es coordinar con el delegado principal y estar preparado para actuar cuando sea necesario.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Estado de Coordinación</label>
                    <select className="w-full border border-gray-300 rounded-lg px-3 py-2">
                      <option value="informado">Informado del caso</option>
                      <option value="coordinando">Coordinando con principal</option>
                      <option value="actuando">Actuando en ausencia</option>
                    </select>
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Contacto con Delegado Principal</label>
                    <select className="w-full border border-gray-300 rounded-lg px-3 py-2">
                      <option value="contactado">Contactado hoy</option>
                      <option value="pendiente">Pendiente contacto</option>
                      <option value="no_disponible">Principal no disponible</option>
                    </select>
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Próxima Coordinación</label>
                    <input
                      type="date"
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Notas de Coordinación</label>
                    <textarea
                      rows={6}
                      className="w-full border border-gray-300 rounded-lg px-3 py-2"
                      placeholder="Notas sobre la coordinación con el delegado principal..."
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      rows={3}
                      className="w-full border border-gray-300 rounded-lg px-3 py-2"
                      placeholder="Documenta las acciones que has realizado como suplente..."
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 bg-gray-50 rounded-lg p-4">
                <h3 className="font-medium text-gray-900 mb-3">Historial de Coordinación</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>Informado del caso</span>
                    <span className="text-gray-500">{new Date(casoSeleccionado.fechaCreacion).toLocaleDateString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Última coordinación</span>
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                <button
                  onClick={() => {
                    alert('Coordinación actualizada correctamente')
                    setShowGestionarCaso(false)
                  }}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Renovación de Certificado Suplente</h2>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <h4 className="font-medium text-purple-900 mb-2">Proceso de Pago</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-purple-800">Renovación certificado LOPIVI Suplente</span>
                      <span className="font-bold text-purple-900">25,00€</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-purple-800">IVA incluido</span>
                      <span className="text-sm text-purple-800">21%</span>
                    </div>
                    <hr className="border-purple-200" />
                    <div className="flex justify-between items-center">
                      <span className="font-medium text-purple-900">Total</span>
                      <span className="font-bold text-purple-900 text-lg">25,00€</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button className="border-2 border-purple-600 bg-purple-50 rounded-lg p-3 text-center">
                      <div className="font-medium text-purple-900">Tarjeta</div>
                      <div className="text-xs text-purple-700">Visa, Mastercard</div>
                    </button>
                    <button className="border-2 border-gray-300 rounded-lg p-3 text-center hover:border-purple-300">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Configuración de Alertas - Suplente</h2>
                  <p className="text-sm text-gray-600">Personaliza las notificaciones del calendario</p>
                </div>
                <button
            ...
            <div className="p-6">
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
                <h3 className="font-bold text-purple-900 mb-2">Alertas para Delegado/a Suplente</h3>
                <p className="text-purple-800 text-sm">
                  Como suplente, recibirás alertas de coordinación y situaciones que requieran tu intervención.
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-medium text-gray-900 mb-4">Tipos de Alertas</h3>
                  <div className="space-y-3">
                    <label className="flex items-center">
                      <input type="checkbox" className="mr-3" defaultChecked />
                      <span className="text-sm">Vencimiento de certificaciones</span>
                    </label>
                    <label className="flex items-center">
                      <input type="checkbox" className="mr-3" defaultChecked />
                      <span className="text-sm">Coordinación con delegado principal</span>
                    </label>
                    <label className="flex items-center">
                      <input type="checkbox" className="mr-3" defaultChecked />
                      <span className="text-sm">Casos que requieren intervención</span>
                    </label>
                    <label className="flex items-center">
                      <input type="checkbox" className="mr-3" />
                      <span className="text-sm">Formaciones de actualización</span>
                    </label>
                    <label className="flex items-center">
                      <input type="checkbox" className="mr-3" defaultChecked />
                      <span className="text-sm">Reuniones de seguimiento</span>
                    </label>
                  </div>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900 mb-4">Anticipación de Alertas</h3>
                  <div className="space-y-3">
                    <div>
                      <label className="block text-sm text-gray-700 mb-1">Certificaciones</label>
                    ...
                    <div>
                      <label className="block text-sm text-gray-700 mb-1">Coordinación</label>
                      <select className="w-full border border-gray-300 rounded px-3 py-2">
                        <option value="7">7 días antes</option>
                    ...
                    <div>
                      <label className="block text-sm text-gray-700 mb-1">Casos Urgentes</label>
                      <select className="w-full border border-gray-300 rounded px-3 py-2">
              ...
              <div className="mt-6 bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-3" />
                    <span className="text-sm">SMS (próximamente)</span>
                  </label>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Protocolo de Actuación - Suplente</h2>
                  <p className="text-sm text-gray-600">Guía paso a paso para el delegado/a suplente</p>
                </div>
                <button
            ...
            <div className="p-6">
              {tipoProtocolo === 'coordinacion-delegado-principal' && (
                <div className="space-y-6">
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                    <h3 className="font-bold text-orange-900 mb-2">COORDINACIÓN CON DELEGADO PRINCIPAL</h3>
                    <p className="text-orange-800 text-sm">Situación de alta prioridad - Tiempo máximo de respuesta: 30 minutos</p>
                  </div>

                  <div className="space-y-4">
                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">1. CONTACTO INMEDIATO (0-10 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Intentar contactar con el delegado principal por todos los medios</li>
                        <li>Verificar si está disponible para actuar</li>
                        <li>Si no está disponible, activar protocolo de sustitución</li>
                        <li>Informar a la dirección de la entidad sobre la situación</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">2. ACTUACIÓN TEMPORAL (10-20 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Asumir las funciones del delegado principal temporalmente</li>
                        <li>Coordinar las acciones necesarias según el protocolo</li>
                        <li>Mantener informado al delegado principal cuando sea posible</li>
                        <li>Documentar todas las acciones realizadas</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">3. SEGUIMIENTO (20-30 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Coordinar la transición de vuelta al delegado principal</li>
                        <li>Completar un informe detallado de las acciones</li>
                        <li>Planificar reunión de seguimiento conjunto</li>
                        <li>Actualizar protocolos si es necesario</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              {tipoProtocolo === 'incidente-suplente' && (
                <div className="space-y-6">
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <h3 className="font-bold text-red-900 mb-2">INCIDENTE DETECTADO COMO SUPLENTE</h3>
                    <p className="text-red-800 text-sm">Situación crítica - Tiempo máximo de respuesta: 15 minutos</p>
                  </div>

                  <div className="space-y-4">
                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">1. EVALUACIÓN INICIAL (0-5 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Evaluar la gravedad de la situación detectada</li>
                        <li>Verificar si requiere intervención inmediata</li>
                        <li>Identificar a las personas involucradas</li>
                        <li>Documentar los hechos observados</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">2. ACTUACIÓN DIRECTA (5-10 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Intervenir para proteger al menor si es necesario</li>
                        <li>Contactar inmediatamente con el delegado principal</li>
                        <li>Si no está disponible, actuar con autoridad completa</li>
                        <li>Contactar con servicios de emergencia si es crítico</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">3. COORDINACIÓN (10-15 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Coordinar con el delegado principal las siguientes acciones</li>
                        <li>Informar a padres/tutores según corresponda</li>
                        <li>Crear informe detallado del incidente</li>
                        <li>Planificar medidas preventivas adicionales</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              {tipoProtocolo === 'apoyo-caso-complejo' && (
                <div className="space-y-6">
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <h3 className="font-bold text-yellow-900 mb-2">APOYO EN CASO COMPLEJO</h3>
                    <p className="text-yellow-800 text-sm">Colaboración - Tiempo máximo de respuesta: 1 hora</p>
                  </div>

                  <div className="space-y-4">
                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">1. COORDINACIÓN INICIAL (0-20 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Reunirse con el delegado principal para entender el caso</li>
                        <li>Revisar la documentación disponible</li>
                        <li>Identificar áreas donde puedes aportar apoyo</li>
                        <li>Establecer plan de colaboración</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">2. APOYO ACTIVO (20-45 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Asistir en la documentación y seguimiento</li>
                        <li>Facilitar comunicaciones con múltiples partes</li>
                        <li>Aportar perspectiva adicional en la resolución</li>
                        <li>Coordinar con otros profesionales si es necesario</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">3. SEGUIMIENTO CONJUNTO (45-60 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Revisar el progreso del caso junto al principal</li>
                        <li>Planificar próximas acciones coordinadas</li>
                        <li>Documentar lecciones aprendidas</li>
                        <li>Establecer protocolo para casos similares futuros</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              {tipoProtocolo === 'comunicacion-familias' && (
                <div className="space-y-6">
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                    <h3 className="font-bold text-orange-900 mb-2">COMUNICACIÓN CON FAMILIAS</h3>
                    <p className="text-orange-800 text-sm">Comunicación - Tiempo máximo de respuesta: 2 horas</p>
                  </div>

                  <div className="space-y-4">
                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">1. PREPARACIÓN (0-30 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Revisar toda la información disponible del caso</li>
                        <li>Coordinar con el delegado principal sobre el mensaje</li>
                        <li>Preparar documentación de respaldo</li>
                        <li>Establecer objetivos claros de la comunicación</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">2. COMUNICACIÓN DIRECTA (30-90 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Contactar con las familias de manera profesional</li>
                        <li>Explicar claramente la situación y las medidas</li>
                        <li>Escuchar sus preocupaciones y responder dudas</li>
                        <li>Documentar los puntos tratados en la conversación</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-bold text-gray-900 mb-2">3. SEGUIMIENTO (90-120 minutos)</h4>
                      <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>Informar al delegado principal sobre los resultados</li>
                        <li>Planificar comunicaciones de seguimiento si es necesario</li>
                        <li>Actualizar registros con información de las familias</li>
                        <li>Coordinar próximos pasos según respuesta familiar</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mt-6">
                <h4 className="font-bold text-purple-900 mb-2">CONTACTOS DE EMERGENCIA</h4>
                <div className="text-sm text-purple-800 space-y-1">
                  <div>Delegado Principal: [Número del principal]</div>
                  <div>Policía Nacional: 091</div>
                  <div>Teléfono ANAR (Niños): 900 20 20 10</div>
                  <div>Servicios Sociales: 900 85 23 52</div>
                  <div>Custodia360 Urgencias: 678 771 198</div>
                </div>
              </div>
