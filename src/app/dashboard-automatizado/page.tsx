                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <p className="text-xs opacity-60 mt-1">
                        {alerta.entidadAfectada} • Detectado: {alerta.fechaDeteccion?.toLocaleTimeString?.() || 'N/A'}
                      </p>
                    </div>
                ...
                <div key={proceso.id} className="border rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium">{proceso.ultimaEjecucion?.toLocaleTimeString?.() || 'N/A'}</div>
                    </div>
                    <div>
                      <div className="text-gray-500">Próxima ejecución</div>
                      <div className="font-medium">{proceso.proximaEjecucion?.toLocaleTimeString?.() || 'N/A'}</div>
                    </div>
                    <div>
