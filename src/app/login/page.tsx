...
export default function LoginDelegadosPage() {
  ...
  const delegadosDB: DelegadoData[] = [
    ...
    // Contratantes/Responsables de entidades
    {
      id: 'cont_001',
      ...
      certificacionVigente: true,
      ultimoAcceso: '2024-01-16 10:30:00'
    },
    {
      id: 'cont_002',
      ...
      permisos: ['ver_cumplimiento', 'gestionar_entidad', 'ver_informes', 'contactar_delegado', 'configuracion'],
      certificacionVigente: true,
      ultimoAcceso: '2024-01-14 15:20:00'
    },
    {
      id: 'cont_003',
  ...
  const authenticateUser = (email: string, password: string): DelegadoData | null => {
    ...
    const demoCredentials = [
      // Delegados ya certificados (acceso directo al dashboard)
      { email: 'delegado@custodia360.com', password: 'custodia2024', tipo: 'principal' },
      { email: 'suplente@custodia360.com', password: 'suplente2024', tipo: 'suplente' },
      { email: 'principal@academia.com', password: 'academia2024', tipo: 'principal' },
      // Delegados nuevos (deben completar el curso LOPIVI)
      { email: 'nuevo@custodia360.com', password: 'nuevo2024', tipo: 'principal' },
      { email: 'suplente-nuevo@custodia360.com', password: 'nuevosup2024', tipo: 'suplente' },
      // Contratantes/Responsables de entidades
      { email: 'director@custodia360.com', password: 'director2024', tipo: 'contratante' },
      { email: 'presidenta@academia.com', password: 'presidenta2024', tipo: 'contratante' },
      { email: 'responsable@nuevaentidad.com', password: 'responsable2024', tipo: 'contratante' },
      // Dashboard Interno Custodia360
      { email: 'rsune@teamsml.com', password: 'Dianita2018', tipo: 'admin_custodia' }
    ]
    ...
    if (validCredential) {
      // Encontrar el delegado en la base de datos usando email y tipo de la credencial válida
      return delegadosDB.find(del => del.email === email && del.tipo === validCredential.tipo) || null
    }
    ...
    try {
      ...
      if (delegado) {
        ...
        if (!delegado.certificacionVigente) {
          ...
          // Redirigir a la página de bienvenida de formación
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-12 px-4">
        ...
        <form onSubmit={handleLogin} className="bg-white rounded-xl shadow-lg p-8 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h3 className="text-sm font-medium text-blue-800 mb-3">Demo - Credenciales de Prueba:</h3>
            <div className="space-y-2 text-xs text-blue-700">
              <div className="space-y-2">
                <p className="font-medium text-green-800">Delegados YA CERTIFICADOS (→ Dashboard):</p>
                <div className="bg-white p-2 rounded border">
                  <p><strong>Principal:</strong> delegado@custodia360.com / custodia2024</p>
                </div>
                <div className="bg-white p-2 rounded border">
                  <p><strong>Suplente:</strong> suplente@custodia360.com / suplente2024</p>
                </div>
              </div>
              <div className="space-y-2">
                <p className="font-medium text-orange-800">Delegados SIN CERTIFICAR (→ Curso LOPIVI):</p>
                <div className="bg-white p-2 rounded border">
                  <p><strong>Principal:</strong> nuevo@custodia360.com / nuevo2024</p>
                </div>
                <div className="bg-white p-2 rounded border">
                  <p><strong>Suplente:</strong> suplente-nuevo@custodia360.com / nuevosup2024</p>
                </div>
              </div>
              <div className="space-y-2">
                <p className="font-medium text-purple-800">Contratantes (→ Dashboard Entidad):</p>
                <div className="bg-white p-2 rounded border">
                  <p><strong>Director:</strong> director@custodia360.com / director2024</p>
                </div>
                <div className="bg-white p-2 rounded border">
                  <p><strong>Presidenta:</strong> presidenta@academia.com / presidenta2024</p>
                </div>
              </div>
              <div className="space-y-2">
                <p className="font-medium text-red-800">Dashboard Interno Custodia360:</p>
                <div className="bg-red-50 p-2 rounded border border-red-200">
                  <p><strong>Admin:</strong> rsune@teamsml.com / Dianita2018</p>
                  <p className="text-xs text-red-600">Solo propietarios de Custodia360</p>
                </div>
              </div>
            </div>
          </div>
