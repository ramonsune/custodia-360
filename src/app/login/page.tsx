      ...
      if (delegado) {
        ...
        if (!delegado.certificacionVigente) {
          ...
          if (delegado.tipo === 'principal') {
            console.log(`👨‍💼 Delegado principal sin formación → /bienvenida-delegado-principal`)
            ...
            console.log(`❓ Tipo de delegado no reconocido: ${delegado.tipo}, usando formación principal`)
            router.push('/bienvenida-delegado-principal')
          }
          return
        }
