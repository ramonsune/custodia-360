    ...
    try {
      ...
      if (delegado) {
        ...
        if (delegado.tipo === 'contratante') {
          ...
          console.log(`👤 Redirigiendo delegado a: /dashboard-delegado`)
    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-12 px-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h3 className="text-sm font-medium text-blue-900 mb-3">Acceso Rápido - Delegados</h3>
          <div className="grid grid-cols-2 gap-2">
            <button
              type="button"
              onClick={() => {
                setLoginData({ email: 'delegado@custodia360.com', password: 'demo', recordarSesion: false })
                setTimeout(() => {
                  const form = { preventDefault: () => {} } as any
                  handleLogin(form)
                }, 100)
              }}
            ...
            <button
              type="button"
              onClick={() => {
                setLoginData({ email: 'suplente@custodia360.com', password: 'demo', recordarSesion: false })
                setTimeout(() => {
                  const form = { preventDefault: () => {} } as any
                  handleLogin(form)
                }, 100)
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
          ...
          <div className="grid grid-cols-1 gap-2">
            <button
              type="button"
              onClick={() => {
                setLoginData({ email: 'director@custodia360.com', password: 'demo', recordarSesion: false })
                setTimeout(() => {
                  const form = { preventDefault: () => {} } as any
                  handleLogin(form)
                }, 100)
            ...
            >
              🏢 Director Entidad → Panel Entidad
            </button>
            <button
              type="button"
              onClick={() => {
                setLoginData({ email: 'responsable@nuevaentidad.com', password: 'demo', recordarSesion: false })
                setTimeout(() => {
                  const form = { preventDefault: () => {} } as any
                  handleLogin(form)
                }, 100)
              ...
              className="bg-orange-600 text-white px-3 py-2 rounded text-sm hover:bg-orange-700 transition-colors"
            >
              🏢 Responsable Entidad → Panel Entidad
            </button>
            <button
              type="button"
              onClick={() => {
                setLoginData({ email: 'presidenta@academia.com', password: 'demo', recordarSesion: false })
                setTimeout(() => {
                  const form = { preventDefault: () => {} } as any
                  handleLogin(form)
                }, 100)
              ...
              className="bg-orange-600 text-white px-3 py-2 rounded text-sm hover:bg-orange-700 transition-colors"
            >
              🏢 Presidenta Academia → Panel Entidad
            </button>
          </div>
        </div>
