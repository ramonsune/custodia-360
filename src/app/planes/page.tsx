...
export default function PlanesPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Planes Principales */}
      <section id="planes-section" className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
          ...
          {/* Información importante sobre pagos divididos */}
          <div className="border border-yellow-300 rounded-xl p-6 mb-6 max-w-4xl mx-auto">
            <div className="text-center">
              <p className="text-yellow-800 font-semibold text-lg">
                El pago fraccionado en dos tramos <strong>solo se ofrece el primer año</strong>
              </p>
              <p className="text-yellow-700 mt-2">
                A partir del segundo año, la renovación será mediante un único pago anual
              </p>
            </div>
          </div>

          {/* Explicación de pagos divididos */}
          <div className="border border-blue-200 rounded-xl p-6 mb-8 max-w-4xl mx-auto">
            ...
            <div className="text-blue-700 text-center">
              <ul className="space-y-2 text-lg font-medium">
                ...
                <li>✓ Ejemplo Plan 100:</li>
                <li className="ml-8">• Precio total: 38€ + IVA</li>
                <li className="ml-8">• 19€ + IVA a la contratación</li>
                <li className="ml-8">• 19€ + IVA a los seis meses</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-8 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <div className="text-4xl font-bold text-gray-800 mb-2">38€</div>
                <p className="text-gray-600 text-sm">más IVA</p>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-blue-800">Pago hoy: 19€ más IVA (solo primer año)</p>
                  <p className="text-sm font-bold text-blue-800">Pago a los seis meses: 19€ más IVA (solo primer año)</p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    ...
                    <li>• Posibilidad de delegado/a suplente (+20€)</li>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <div className="text-4xl font-bold text-gray-800 mb-2">78€</div>
                <p className="text-gray-600 text-sm">más IVA</p>
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-green-800">Pago hoy: 39€ más IVA (solo primer año)</p>
                  <p className="text-sm font-bold text-green-800">Pago a los seis meses: 39€ más IVA (solo primer año)</p>
                </div>
                <p className="text-xs text-gray-500 mt-1">Implementación completa en 72h</p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm">más IVA</p>
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-purple-800">Pago hoy: 105€ más IVA (solo primer año)</p>
                  <p className="text-sm font-bold text-purple-800">Pago a los seis meses: 105€ más IVA (solo primer año)</p>
                </div>
                <p className="text-xs text-gray-500 mt-1">Implementación completa en 72h</p>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm">más IVA</p>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-gray-800">Pago hoy: 250€ más IVA (solo primer año)</p>
                  <p className="text-sm font-bold text-gray-800">Pago a los seis meses: 250€ más IVA (solo primer año)</p>
                </div>
            ...
            <div className="text-center mb-8">
              ...
              <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 max-w-4xl mx-auto">
                <p className="text-teal-800 font-medium">
                  Se puede añadir en el momento de la contratación - 40€ (+IVA) pago único
                </p>
              </div>
            </div>
            ...
            <table className="w-full bg-white rounded-lg shadow-lg">
              <thead>
                <tr className="bg-gray-50">
                  ...
                  <th className="text-center p-6 font-bold text-blue-600">C360</th>
