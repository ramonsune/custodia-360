...
interface NuevoCaso {
  ...
  testigos: string
  urgencia: 'inmediata' | 'misma_jornada' | 'proximos_dias' | 'seguimiento'
...
export default function NuevoCasoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const casoId = `CASO-2024-${String(Math.floor(Math.random() * 999) + 1).padStart(3, '0')}`

      // Aquí iría la lógica real de guardado en base de datos
      console.log('Nuevo caso registrado:', {
        ...nuevoCaso,
        id: casoId,
      ...
      alert(`✅ Caso ${casoId} registrado correctamente`)
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-6">
              <button
                type="button"
                onClick={() => setNuevoCaso({...nuevoCaso, urgencia: 'inmediata', prioridad: 'critica'})}
                className={`p-3 rounded-lg border-2 transition-all ${
                  nuevoCaso.urgencia === 'inmediata'
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-sm font-medium">Inmediata</div>
                  <div className="text-xs text-gray-500">Riesgo vital</div>
                </div>
              </button>

              <button
                type="button"
                onClick={() => setNuevoCaso({...nuevoCaso, urgencia: 'misma_jornada', prioridad: 'alta'})}
                className={`p-3 rounded-lg border-2 transition-all ${
                  nuevoCaso.urgencia === 'misma_jornada'
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-sm font-medium">Misma Jornada</div>
                  <div className="text-xs text-gray-500">Mismo día</div>
                </div>
              </button>

              <button
                type="button"
                onClick={() => setNuevoCaso({...nuevoCaso, urgencia: 'proximos_dias', prioridad: 'media'})}
                className={`p-3 rounded-lg border-2 transition-all ${
                  nuevoCaso.urgencia === 'proximos_dias'
              ...
              >
                <div className="text-center">
                  <div className="text-2xl mb-1">📅</div>
                  <div className="text-sm font-medium">Próximos Días</div>
                  <div className="text-xs text-gray-500">2-3 días</div>
                </div>
              </button>

              <button
                type="button"
                onClick={() => setNuevoCaso({...nuevoCaso, urgencia: 'seguimiento', prioridad: 'baja'})}
                className={`p-3 rounded-lg border-2 transition-all ${
                  nuevoCaso.urgencia === 'seguimiento'
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-500">Rutinario</div>
                </div>
              </button>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    ...
                    <optgroup label="⚠️ Situaciones de Riesgo">
