...
export default function CertificadoDelegadoPage() {
  ...
  const descargarCertificado = async () => {
    ...
    try {
      ...
      doc.setDrawColor(37, 99, 235);
      doc.setLineWidth(1);
      const nombreWidth = doc.getTextWidth(usuario.nombre.toUpperCase()) * 20 / doc.internal.scaleFactor;
      doc.line(
      ...
      doc.setFontSize(9);
      yPos += 8;
      doc.text(`Tipo de Delegado: ${usuario.tipo.charAt(0).toUpperCase() + usuario.tipo.slice(1)}`, leftColumn, yPos);
      yPos += 6;
      ...
      // Descargar
      doc.save(`Certificado_Delegado_${usuario.nombre.replace(/\s+/g, '_')}_${codigoVerificacion}.pdf`);
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow-2xl overflow-hidden border border-gray-200">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-8 text-white">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold mb-2">CERTIFICADO CUSTODIA360</h2>
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto">
                ...
                <strong> Delegado de Protección</strong> según los estándares establecidos por la LOPIVI,
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div>
                      <span className="text-gray-600">Tipo de Delegado:</span>
            ...
            <div className="border-t pt-6">
              <div className="flex justify-center items-end">
                <div className="text-center">
                  <div className="w-24 h-24 bg-blue-600 rounded-lg flex flex-col items-center justify-center mb-2 border-2 border-blue-800 text-white">
                    <span className="text-white font-bold text-sm">CUSTODIA360</span>
                    <span className="text-white text-xs">SELLO OFICIAL</span>
                  </div>
                  <div className="border-b border-gray-400 w-48 mb-2"></div>
                  <p className="text-sm text-gray-600 font-bold">Custodia360</p>
        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-6">
          ...
          <div className="text-sm text-blue-800 space-y-2">
            ...
            <p>• El código de verificación <strong>{codigoVerificacion}</strong> permite validar la autenticidad del certificado.</p>
            <p>• Este documento acredita su competencia como Delegado de Protección según LOPIVI.</p>
        ...
        <div className="mt-6 bg-green-50 rounded-lg p-6 border border-green-200">
          ...
          <div className="text-sm text-green-800 space-y-2">
            ...
            <p>• <strong>Información asociada:</strong> Nombre, entidad, fecha, puntuación y tipo de delegado</p>
            <p>• <strong>Validación:</strong> Cualquier entidad puede verificar la autenticidad con este código</p>
