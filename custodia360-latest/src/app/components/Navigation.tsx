            ...
            <div className="p-6 space-y-1">
                ...
                >
                  <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                    <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m-7 4h6m2-15h3a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h3m2-2v4h4V3m-4 0a2 2 0 00-2-2H7a2 2 0 00-2 2v1" />
                    </svg>
                  </div>
                  <div>
                    <div className="font-medium text-gray-700">Demo</div>
                    <div className="text-xs text-gray-500">Ver funcionamiento</div>
                  </div>
                </Link>
              ...
              <div className="pt-6 border-t border-gray-200 mt-6">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-gray-700">Acceso Delegados</div>
