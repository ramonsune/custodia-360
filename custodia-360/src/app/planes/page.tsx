            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-blue-800">Pago hoy: 19€ más IVA</p>
                  <p className="text-sm font-bold text-blue-800">Pago a los seis meses: 19€ más IVA</p>
                </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-green-800">Pago hoy: 39€ más IVA</p>
                  <p className="text-sm font-bold text-green-800">Pago a los seis meses: 39€ más IVA</p>
                </div>
                <p className="text-xs text-gray-500 mt-1">Implementación completa en 72h</p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-purple-800">Pago hoy: 105€ más IVA</p>
                  <p className="text-sm font-bold text-purple-800">Pago a los seis meses: 105€ más IVA</p>
                </div>
                <p className="text-xs text-gray-500 mt-1">Implementación completa en 72h</p>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg text-center">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 mt-3 mb-2">
                  <p className="text-sm font-bold text-gray-800">Pago hoy: 250€ más IVA</p>
                  <p className="text-sm font-bold text-gray-800">Pago a los seis meses: 250€ más IVA</p>
                </div>
